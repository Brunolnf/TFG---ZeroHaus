...
@Composable
fun PreestudioScreen(onVolver: () -> Unit = {}) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Nuevo preestudio") },
                navigationIcon = {
        ...
        Column(
            ...
            Text("Formulario de preestudio energético", fontWeight = FontWeight.Bold)
            OutlinedTextField(
                "100",
                {},
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun TecnicosScreen(onVolver: () -> Unit = {}) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Técnicos certificados") },
                navigationIcon = {
                    IconButton(onClick = onVolver) {
                        Icon(Icons.Default.ArrowBack, contentDescription = null)
                    }
            ...
            repeat(3) {
                Card(
                    ...
                    Column(Modifier.padding(14.dp)) {
                        Text("Técnico ${it + 1}", fontWeight = FontWeight.SemiBold)
                        Text("Especialidad energética", fontSize = 12.sp, color = Color.Gray)
                        Button(
                            onClick = {},
                            modifier = Modifier.fillMaxWidth(),
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun RankingsScreen(onVolver: () -> Unit = {}) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Rankings") },
            ...
            repeat(3) {
                Card(
                    ...
                    Row(
                        ...
                        Column {
                            Text("Técnico Top ${it + 1}", fontWeight = FontWeight.SemiBold)
                            Text("Valoración excelente", fontSize = 12.sp, color = Color.Gray)
                        }
                    }
                }
            }
